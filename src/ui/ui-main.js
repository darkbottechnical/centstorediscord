function initialiseProfileSection() {
...
function initialiseTabControls() {
    ...
    tabControlContainers.forEach((controlContainer) => {
        ...
        const contentContainer = document.querySelector(`.tab-container[data-tabset="${tabSetId}"]`);
        ...
        controls.forEach((control) => {
            control.addEventListener("click", () => {
                ...
                const targetContent = contentContainer.querySelector(`:scope > [data-tab="${targetId}"]`);
